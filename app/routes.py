...
def oauth_callback():
    ...
    #  Step 2: (Optional now, or for later use) Refresh the access token
    refresh_payload = {
    ...
    if "errors" in data:
        ...
        username = marketplace.get("name", "Unknown Marketplace")
        return render_template("seller.html", data=username)
